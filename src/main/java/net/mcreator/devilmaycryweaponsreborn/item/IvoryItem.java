...
import net.mcreator.devilmaycryweaponsreborn.procedures.IvoryRangedItemUsedProcedure;
import net.mcreator.devilmaycryweaponsreborn.entity.BulletPlaceholderEntity;

import java.util.List;

public class IvoryItem extends Item {
	public IvoryItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		IvoryRangedItemUsedProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity);
		return ar;
	}
