...
import net.mcreator.devilmaycryweaponsreborn.procedures.CoyoteARangedItemUsedProcedure;
...
public class CoyoteAItem extends Item {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entity, int time) {
		if (!world.isClientSide() && entity instanceof ServerPlayer player) {
			ItemStack stack = ProjectileWeaponItem.getHeldProjectile(entity, e -> e.getItem() == CoyoteAProjectileEntity.PROJECTILE_ITEM.getItem());
			...
			if (player.getAbilities().instabuild || stack != ItemStack.EMPTY) {
				CoyoteAProjectileEntity projectile = CoyoteAProjectileEntity.shoot(world, entity, world.getRandom());
