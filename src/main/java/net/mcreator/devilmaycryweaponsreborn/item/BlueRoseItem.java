...
import net.mcreator.devilmaycryweaponsreborn.procedures.BlueRoseUsedProcedure;
import net.mcreator.devilmaycryweaponsreborn.entity.BulletPlaceholderEntity;

import java.util.List;

public class BlueRoseItem extends Item {
	public BlueRoseItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		BlueRoseUsedProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity);
		return ar;
	}
