...
import net.mcreator.devilmaycryweaponsreborn.procedures.RedQueenLivingEntityIsHitWithToolProcedure;
import net.mcreator.devilmaycryweaponsreborn.init.DevilMayCryWeaponsRebornModItems;

@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD)
public class RedQueenItem extends SwordItem {
	...
	public static void handleToolDamage(ModifyDefaultComponentsEvent event) {
		event.modify(DevilMayCryWeaponsRebornModItems.RED_QUEEN.get(), builder -> builder.remove(DataComponents.MAX_DAMAGE));
	}
