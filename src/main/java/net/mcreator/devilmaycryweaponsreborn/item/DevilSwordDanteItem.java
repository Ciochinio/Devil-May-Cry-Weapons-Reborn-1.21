...
import net.mcreator.devilmaycryweaponsreborn.procedures.DevilSwordDanteLivingEntityIsHitWithToolProcedure;
import net.mcreator.devilmaycryweaponsreborn.init.DevilMayCryWeaponsRebornModItems;

@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD)
public class DevilSwordDanteItem extends SwordItem {
	...
	public static void handleToolDamage(ModifyDefaultComponentsEvent event) {
		event.modify(DevilMayCryWeaponsRebornModItems.DEVIL_SWORD_DANTE.get(), builder -> builder.remove(DataComponents.MAX_DAMAGE));
	}
