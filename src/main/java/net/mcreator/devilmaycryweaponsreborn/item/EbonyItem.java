...
import net.mcreator.devilmaycryweaponsreborn.procedures.EbonyRangedItemUsedProcedure;
import net.mcreator.devilmaycryweaponsreborn.entity.BulletPlaceholderEntity;

import java.util.List;

public class EbonyItem extends Item {
	public EbonyItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		EbonyRangedItemUsedProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity);
		return ar;
	}
