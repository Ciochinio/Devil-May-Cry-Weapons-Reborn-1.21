...
import net.mcreator.devilmaycryweaponsreborn.procedures.KalinaAnnIIRangedItemUsedProcedure;
import net.mcreator.devilmaycryweaponsreborn.entity.BulletPlaceholderEntity;

import java.util.List;

public class KalinaAnnIIItem extends Item {
	public KalinaAnnIIItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		KalinaAnnIIRangedItemUsedProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity);
		return ar;
	}
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entity, int time) {
		if (!world.isClientSide() && entity instanceof ServerPlayer player) {
			ItemStack stack = ProjectileWeaponItem.getHeldProjectile(entity, e -> e.getItem() == BulletPlaceholderEntity.PROJECTILE_ITEM.getItem());
