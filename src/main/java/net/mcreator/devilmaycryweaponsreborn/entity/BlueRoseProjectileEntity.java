...
public class BlueRoseProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public BlueRoseProjectileEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(DevilMayCryWeaponsRebornModEntities.BLUE_ROSE_PROJECTILE.get(), world);
	}
	...
	public BlueRoseProjectileEntity(EntityType<? extends BlueRoseProjectileEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public BlueRoseProjectileEntity(EntityType<? extends BlueRoseProjectileEntity> type, LivingEntity entity, Level world) {
	...
	public static BlueRoseProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		BlueRoseProjectileEntity entityarrow = new BlueRoseProjectileEntity(DevilMayCryWeaponsRebornModEntities.BLUE_ROSE_PROJECTILE.get(), entity, world);
	...
	public static BlueRoseProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		BlueRoseProjectileEntity entityarrow = new BlueRoseProjectileEntity(DevilMayCryWeaponsRebornModEntities.BLUE_ROSE_PROJECTILE.get(), entity, entity.level());
