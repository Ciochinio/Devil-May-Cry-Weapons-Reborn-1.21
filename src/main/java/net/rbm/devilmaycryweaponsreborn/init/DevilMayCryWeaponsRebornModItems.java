...
import net.rbm.devilmaycryweaponsreborn.item.YamatoSwordItem;
import net.rbm.devilmaycryweaponsreborn.item.RedQueenSwordItem;
import net.rbm.devilmaycryweaponsreborn.item.RebellionSwordItem;
...
import net.rbm.devilmaycryweaponsreborn.item.DevilSwordSpardaSwordItem;
import net.rbm.devilmaycryweaponsreborn.item.DevilSwordDanteSwordItem;
...
public class DevilMayCryWeaponsRebornModItems {
	...
	public static final DeferredItem<Item> DEVIL_SWORD_DANTE_SWORD = REGISTRY.register("devil_sword_dante_sword", DevilSwordDanteSwordItem::new);
	public static final DeferredItem<Item> RED_QUEEN_SWORD = REGISTRY.register("red_queen_sword", RedQueenSwordItem::new);
	public static final DeferredItem<Item> REBELLION_SWORD = REGISTRY.register("rebellion_sword", RebellionSwordItem::new);
	public static final DeferredItem<Item> YAMATO_SWORD = REGISTRY.register("yamato_sword", YamatoSwordItem::new);
	public static final DeferredItem<Item> DEVIL_SWORD_SPARDA_SWORD = REGISTRY.register("devil_sword_sparda_sword", DevilSwordSpardaSwordItem::new);
