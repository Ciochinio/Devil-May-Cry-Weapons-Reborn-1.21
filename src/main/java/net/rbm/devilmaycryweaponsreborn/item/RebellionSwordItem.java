...
public class RebellionSwordItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_WOODEN_TOOL, 0, 2f, 0, 1, TagKey.create(Registries.ITEM, ResourceLocation.parse("devil_may_cry_weapons_reborn:rebellion_sword_repair_items")));
