...
@EventBusSubscriber
public class DevilSwordSpardaSwordItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_WOODEN_TOOL, 0, 9f, 0, 15, TagKey.create(Registries.ITEM, ResourceLocation.parse("devil_may_cry_weapons_reborn:devil_sword_sparda_sword_repair_items")));

	public DevilSwordSpardaSwordItem(Item.Properties properties) {
